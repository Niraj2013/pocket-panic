...
@onready var CaughtCounter = $CaughtCounter
@onready var RemainingCounter = $RemainingCounter
...
func _ready() -> void:
	CaughtCounter.text = str(heart_collected)
	RemainingCounter.text = str(4 - heart_collected)
...
func Heart_collect() -> void:
	...
	var remaining_value = 4 - heart_collected
	if remaining_value < 0:
		remaining_value = 0
	RemainingCounter.text = str(remaining_value)
